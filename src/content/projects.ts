...
export const projects: Project[] = [
  {
    ...
    tags: ["React", "TypeScript", "Fast API", "Cohere API", "NLTK", "NLP"],
    ...
    description:
      "An NLP app that processes e-commerce reviews with sentiment analysis to help determine if you should buy a product.",
    howItsBuilt: [
