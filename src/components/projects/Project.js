export default function Project({ project }) {
  ...
  return (
    <div className='flex flex-col justify-center items-start my-4 p-[5%] bg-primary-200 text-light-text bg-opacity-20 rounded-xl w-full h-auto animate-appear'>
      ...
      <h3 className="text-xl py-4 font-display font-bold text-neutral-150">Description</h3>
      <p>{project?.content?.DESCRIPTION}</p>
      <h3 className="text-xl py-4 font-display font-bold text-neutral-150">How I Built It</h3>
