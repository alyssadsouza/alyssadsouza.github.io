...
export default function ProjectSidebar({items}) {
  return (
      <section id="projects" className="flex flex-col items-stretch justify-start px-10 py-6 w-full text-neutral-800 md:h-[90%] md:overflow-y-auto">
        ...
        <h3 className="uppercase text-[#627FCA] font-display tracking-[0.2rem]">Projects</h3>
